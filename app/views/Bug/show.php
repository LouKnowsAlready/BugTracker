...
<hr>
	<form action="/bug/create" method="POST" data-ajax="false">
		<div>
			<input type="hidden" name="bug[project_id]" value="<?php echo $project->id ?>" disabled />
		</div>
		<div>
			<label>Issue Name</label>
			<input type="text" data-clear-btn="true" name="bug[bug_name]" value="<?php echo $bug->bug_name ?>" disabled />
		</div>
		<div>
			<label>Details</label>
			<textarea name="bug[details]" disabled> <?php echo $bug->details ?> </textarea>
		</div>		
		<div>
			<label> Assigned To </label>
			<select name="bug[assigned_to]" disabled>
				<?php 
		...
		<div>
			...
			<select name="bug[priority_id]" disabled>
				<?php 
		...
		<div>
			<label> Status </label>
			<select name="bug[status_id]" disabled>
				<?php 
